...
// ============================================================
//  STEP 1A: MediaContent = Abstract Base Class
// ============================================================
class MediaContent {
private:
    int    contentID;
...
// ============================================================
//  STEP 1B: StreamingEngine = Abstract Base Class
// ============================================================
...
// ============================================================
//  STEP 1C: User - Abstract Base Class
// ============================================================
class User {
private:
    int    userID;
...
void printMainMenu() {
    ...
    cout << "â•‘         CINESTREAM PLATFORM          â•‘\n";
    cout << "â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£\n";
    cout << "â•‘  1. Register (Free Account)          â•‘\n";
    cout << "â•‘  2. Register (Premium Account)       â•‘\n";
    cout << "â•‘  3. Login                            â•‘\n";
    cout << "â•‘  4. Browse Catalog (no login needed) â•‘\n";
    cout << "â•‘  0. Exit                             â•‘\n";
...
void printUserMenu(const string& name, const string& type) {
    cout << "\nâ•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\n";
    cout << "â•‘  Logged in: " << name;
    cout << string(max(0, 26 - (int)name.size()), ' ') << "â•‘\n";
    cout << "â•‘  Account  : " << type;
    cout << string(max(0, 26 - (int)type.size()), ' ') << "â•‘\n";
    cout << "â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£\n";
    cout << "â•‘  1. Browse Catalog                   â•‘\n";
    cout << "â•‘  2. Search Content                   â•‘\n";
    cout << "â•‘  3. Watch a Movie                    â•‘\n";
    cout << "â•‘  4. Watch a Documentary              â•‘\n";
    cout << "â•‘  5. Rate Content                     â•‘\n";
    cout << "â•‘  6. View Ratings for Content         â•‘\n";
    cout << "â•‘  7. My Watch History                 â•‘\n";
    cout << "â•‘  8. My Profile                       â•‘\n";
    cout << "â•‘  9. File Status                      â•‘\n";
    cout << "â•‘  0. Logout                           â•‘\n";
    cout << "â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\n";
    cout << "Choice: ";
}
